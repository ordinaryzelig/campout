...
class ConfirmTheatersTrackedTweet < TweetString
  ...
  def initialize(theaters)
    message_without_theater = TweetString.new("I'm tracking #{theaters.size} theaters including %s. If this is wrong, send me a Direct Message with the correct postal_code.")
